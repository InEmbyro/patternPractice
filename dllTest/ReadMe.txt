================================================================================
    MFC 程式庫 : dllTest 專案概觀
===============================================================================

應用程式精靈已經為您建立了這個 dllTest 應用程式。這個應用程式
不僅示範了使用 MFC 的基本概念，也是您撰寫應用程式的起點。

這個檔案的內容摘要，包含各個構成 dllTest 應用程式的檔案。
...
dllTest.h
    ...
    並宣告 CdllTestApp 應用程式類別。

dllTest.cpp
    這是主要的應用程式原始程式檔，它包含應用程式類別 CdllTestApp。
...
StdAfx.h、StdAfx.cpp
    這些檔案是用來建置名為 dllTest.pch 的先行編譯標頭 (PCH) 檔，
